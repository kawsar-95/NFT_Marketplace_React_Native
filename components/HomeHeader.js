    ...
    <View style={{
      ...
      <View style={{ marginVertical: SIZES.font }} >
        ...
        <Text style={{ fontFamily: FONTS.bold, fontSize: SIZES.large, color: COLORS.white,marginTop:SIZES.base }} >
          Let's Find a MasterPiece Token ✨
          </Text>
        </View>
        <View style={{ marginVertical: SIZES.font }} >
        <View style={{
          width: '100%', borderRadius: SIZES.font, backgroundColor: COLORS.gray, flexDirection: 'row', alignItems: 'center',
          paddingHorizontal:SIZES.font,paddingVertical:SIZES.small-2
        }} >
          <Image
